    ...
    return {
        update: function(values, texts, images, qrcodes, editor) {
          ...
          //  texts.email.setDeltaY(values.mobil === "" ? -4 : 0);
            ...
            var phone = '+49 731 93680 ' + (values.durchwahl === '' ? '' : values.durchwahl);
            ...
            qrcode += "EMAIL;type=INTERNET;type=WORK:" + values.email + "\n" +
                    ...
                    "TEL;type=WORK:" + phone + "\n" +
                    "ADR;TYPE=INTL,POSTAL,WORK:;;27 allee du Roussillon;Colomiers;;31770;France\n" +
                    "URL;TYPE=WORK:https://www.ingenics.com\n" +
                    "END:VCARD";
