function handler() {
    return {
        update: function(values, texts, images, qrcodes, editor) {
            ...
            texts.emailA.setText(emailA);
            texts.emailB.setText(emailB);
            //texts.email.setText(values.email);
            texts.emailA.setDeltaY(values.mobil === "" ? 6.4 : 0);
            texts.emailB.setDeltaY(values.mobil === "" ? 6.4 : 0);
