    ...
    return {
        update: function(values, texts, images, qrcodes, editor) {
           ...
           // texts.email.setDeltaY(values.mobil === "" ? -4 : 0);
            ...
            var phone = '+420 246 087 ' + (values.durchwahl === '' ? 0 : values.durchwahl);
            ...
            var qrcode = "BEGIN:VCARD\n" +
                    ...
                    "FN:" + name + "\n" +
                    "ORG:Ingenics Management Consulting Ltd.\n";
            ...
            qrcode += "EMAIL;type=INTERNET;type=WORK:" + values.email + "\n" +
                    ...
                    "ADR;type=WORK:;;170 Edmund Street;Birmingham B3 2HB;;15800;United Kingdom\n" +
                    "END:VCARD";
