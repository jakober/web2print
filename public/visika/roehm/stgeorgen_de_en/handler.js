function handler(editor) {
    var r = {
        update: function(values, texts, images, qrcodes, editor) {
            var n = [],
                    pre_fon = '+49 77 24 94 68 ', pre_fax = pre_fon,
                    maxlength = 250;
            ...
            if (values.fon === '') {
                ...
                var t;
                texts.fon.setText(t=pre_fon + values.fon.replace(' ', '').chunkString([2, 1E6]).join(' '));
            ...
            if (values.fax === '') {
                ...
                var t;
                texts.fax.setText(t=pre_fax + values.fax.replace(' ', '').chunkString([2, 1E6]).join(' '));
