function handler() {
    return {
        update: function(values, texts, images, qrcodes, editor) {
            var n = [],
                    ...
                    , pre_mobil = 'M +49 (0) '
                    , pre_mail = '@hartmann.info'
                    , pre_servicefon = 'T +49 (0) 800 '
                    , pre_servicefax = 'F +49 (0) 800 ',
                    maxlength = 250;
    ...
    //        texts.telefon.setText("Tel. " + phone);
            ...
            texts.servicefon.setText(pre_servicefon + values.servicefon + "*");
            texts.servicefax.setText(pre_servicefax + values.servicefax + "*");
