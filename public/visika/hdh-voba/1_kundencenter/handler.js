...
/*            texts.funktion2.setText(values.funktion2);
            ...
            var stelle = values.stelle;
            if (stelle === "(Freitext)") {
                editor.showRow('stelle_freitext');
                stelle = values.stelle_freitext;
            } else {
                editor.hideRow('stelle_freitext');
            }

            texts.stelle.setText(stelle);
            if (values.stelle === '') {
                deltaY -= 2.9;
            }
            ...
            texts.stelle_fix.setDeltaY(deltaY);


            var stelle2 = "Kundencenter";
            var strasse = "Karlstr. 3";
            var plz = "89518";
            var ort = "Heidenheim";

            // Adresse direkt einfügen
            var adresse = stelle2 + ", " + strasse + ";" + plz + ";" + ort;
