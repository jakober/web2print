function handler(editor) {
    var r = {
        update: function(values, texts, images, qrcodes, editor) {
            ...
            texts.stelle.setText(values.stelle);
            texts.stelle2.setText(values.stelle2);
            texts.strasse.setText(values.strasse);
            texts.ort.setText(values.ort);
            texts.telefon.setText(values.telefon);
            texts.telefax.setText(values.telefax);
            ...
            texts.stelle2.setDeltaY(deltaY);
            ...
            var stelle = "Geschäftsstelle Dischingen";
            ...
            if (values.telefon !== '') {
                vCard += 'TEL;TYPE=WORK,VOICE:' + values.telefon + '\n';
            }
            if (values.mobil !== '') {
